$(document).ready(function () {
    ...
    $(".sign").click(function () {
        ...
        $("#userInput").val(currentExpression + allButLastNum);
        // var workingExpression = currentExpression  // copy to address access issues after lastOpIndex
        // var lastNum = "";
        // var allButLastNum = "";
        // var matchOp = workingExpression.match( /[+/*-]/g );  // order of operators in regex vital!
        // var lastOpIndex = workingExpression.lastIndexOf( matchOp[matchOp.length-1] );  // index of last operator
        // if (workingExpression.match( "[-+*/]" ) ) {  // if there are any operators
        //   lastNum = workingExpression.substr( lastOpIndex+1 );  // save number after last operator
        // } else {
        //   lastNum = workingExpression;  // otherwise save lonely number
        // }
        // if (workingExpression.match( "[-+*/]" ) ) {  // if there are any operators
        //   allButLastNum = workingExpression.substr( 0, lastOpIndex+1 );  // save everything before last number
        // }
